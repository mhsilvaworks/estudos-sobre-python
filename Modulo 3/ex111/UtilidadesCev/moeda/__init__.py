...
def resumo (x,a,b):
    ...
    print(f'{'RESUMO':>20}')
    print('='*35)
    print(f'{'Se aumentar 10%:':<20} {aumentar(x,a,True)}')
    print(f'{'Se diminuir 10%:':<20} {diminuir(x,b, True)}')
    print(f'{'Se dobrar:':<20} {dobro(x, True)}')
    print(f'{'Se dividir por 2:':<20} {metade(x, True)}')
    print('='*35)